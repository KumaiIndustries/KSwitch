...
namespace Ryujinx.Headless.SDL2
{
    abstract partial class WindowBase : IHostUIHandler, IDisposable
    {
        ...
        private void InitializeWindow()
        {
            ...
            WindowHandle = SDL_CreateWindow($"KSwitch {Program.Version}{titleNameSection}{titleVersionSection}{titleIdSection}{titleArchSection}", SDL_WINDOWPOS_CENTERED_DISPLAY(DisplayId), SDL_WINDOWPOS_CENTERED_DISPLAY(DisplayId), Width, Height, DefaultFlags | FullscreenFlag | GetWindowFlags());

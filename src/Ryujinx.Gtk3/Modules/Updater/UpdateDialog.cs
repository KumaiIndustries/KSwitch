...
#pragma warning restore CS0649, IDE0044
        ...
        private UpdateDialog(Builder builder, MainWindow mainWindow, Version newVersion, string buildUrl) : base(builder.GetRawOwnedObject("UpdateDialog"))
        {
            ...
            Icon = new Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "Ryujinx.UI.Common.Resources.Logo_KSwitch.png");
            MainText.Text = "Do you want to update KSwitch to the latest version?";
        ...
        private void YesButton_Clicked(object sender, EventArgs args)
        {
            if (_restartQuery)
            {
                string ryuName = OperatingSystem.IsWindows() ? "KSwitch.exe" : "KSwitch";

...
namespace Ryujinx.UI.Windows
{
    public partial class AboutWindow : Window
    {
        ...
        private void InitializeComponent()
        {
            ...
            // _ryujinxLogo
            //
            _ryujinxLogo = new Image(new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "Ryujinx.UI.Common.Resources.Logo_KSwitch.png", 100, 100))
            {
                Margin = 10,
                MarginStart = 15,
            };
            ...
            // _ryujinxLabel
            //
            _ryujinxLabel = new Label("KSwitch")
            {
                MarginTop = 15,
            ...
            //
            _ryujinxPhoneticLabel = new Label("(K-Switch)")
            {
                Justify = Justification.Center,
            };

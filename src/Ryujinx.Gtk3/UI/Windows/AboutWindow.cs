...
namespace Ryujinx.UI.Windows
{
    ...
    {
        public AboutWindow() : base($"KSwitch {Program.Version} - About")
        {
            Icon = new Gdk.Pixbuf(Assembly.GetAssembly(typeof(OpenHelper)), "Ryujinx.UI.Common.Resources.Logo_KSwitch.png");
            InitializeComponent();

...
namespace Ryujinx.UI.Windows
{
    public partial class UserProfilesManagerWindow : Window
    {
        ...
        public UserProfilesManagerWindow(AccountManager accountManager, ContentManager contentManager, VirtualFileSystem virtualFileSystem) : base($"KSwitch {Program.Version} - Manage User Profiles")
        {

...
#pragma warning restore CS0649, IDE0044, CS0169, IDE0051
        ...
        public MainWindow() : this(new Builder("KSwitch.Gtk3.UI.MainWindow.glade")) { }
        ...
        private MainWindow(Builder builder) : base(builder.GetRawOwnedObject("_mainWin"))
        {
            ...
            Icon = new Gdk.Pixbuf(Assembly.GetAssembly(typeof(ConfigurationState)), "Ryujinx.UI.Common.Resources.Logo_KSwitch.png");
            Title = $"KSwitch {Program.Version}";
            ...
            if (File.Exists(path))
            {
                switch (System.IO.Path.GetExtension(path).ToLowerInvariant())
                {
                    ...
                    default:
                        ...
                        {
                            Logger.Error?.Print(LogClass.Application, "The specified file is not supported by KSwitch.");
        ...
        private void SwitchToGameTable()
        {
            ...
            Window.Title = $"KSwitch {Program.Version}";
        ...
        private void HandleInstallerDialog(FileChooserNative fileChooser)
        {
            if (fileChooser.Run() == (int)ResponseType.Accept)
            {
                try
                {
                    ...
                    string dialogMessage = $"Kswitch system version {firmwareVersion.VersionString} will be installed.";

                    if (currentVersion != null)
                    {
                        dialogMessage += $"\n\nThis will replace the current KSwitch system version {currentVersion.VersionString}. ";
                    }
                        ...
                        Thread thread = new(() =>
                        {
                            ...
                            try
                            {
                                ...
                                Application.Invoke(delegate
                                {
                                    ...
                                    string message = $"Kswitch system version {firmwareVersion.VersionString} successfully installed.";

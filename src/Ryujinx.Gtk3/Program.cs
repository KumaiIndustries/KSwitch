...
namespace Ryujinx
{
    partial class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                MessageBoxA(IntPtr.Zero, "You are running an outdated version of Windows.\n\nKSwitch supports Windows 10 version 1803 and newer.\n", $"KSwitch {Version}", MbIconWarning);
            }
            ...
            Console.Title = $"KSwitch Console {Version}";
                ...
                if (LinuxHelper.VmMaxMapCount < LinuxHelper.RecommendedVmMaxMapCount)
                {
                    ...
                    if (LinuxHelper.PkExecPath is not null)
                    {
                        ...
                        ResponseType response = GtkDialog.CreateCustomDialog(
                            "KSwitch - Low limit for memory mappings detected",
                            ...
                            "KSwitch will crash as soon as this limit gets exceeded.",
                            buttonTexts,
                    ...
                    else
                    {
                        GtkDialog.CreateWarningDialog(
                            ...
                            "Some games might try to create more memory mappings than currently allowed. " +
                            "KSwitch will crash as soon as this limit gets exceeded.\n\n" +
                            "You might want to either manually increase the limit or install pkexec, which allows KSwitch to assist with that.");
                    }
                }
            }
        ...
        {
            Logger.Notice.Print(LogClass.Application, $"KSwitch System Version: {Version}");
